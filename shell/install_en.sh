...
aliasInstall() {
	...
	if [[ -f "$HOME/install.sh" ]] && [[ -d "/etc/v2ray-agent" ]] && grep <$HOME/install.sh -q "author：wangyu0829"; then
...
dokodemoDoorUnblockNetflix() {
	...
	echoContent red "\n=============================================================="
	echoContent yellow "# Precautions"
	echoContent yellow "Any door unlock detailed, please check this article[https://github.com/wangyu0829/v2ray-agent/blob/master/documents/netflix/dokodemo-unblock_netflix.md]\n"
...
menu() {
	cd "$HOME" || exit
	echoContent red "\n=============================================================="
	echoContent green "author：wangyu0829"
